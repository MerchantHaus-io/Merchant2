  ...
  return (
    <section className="container mx-auto px-6 py-12 overflow-hidden">
      ...
      <div className="text-center mb-16">
        <h2 className="text-5xl md:text-6xl font-bold font-ubuntu tracking-tight animate-fade-in">MerchantHaus Core Services</h2>
        <p className="mt-6 text-xl text-muted-foreground max-w-3xl mx-auto animate-fade-in">Innovative solutions designed to power modern commerce safely and efficiently across the globe.</p>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="max-w-xl text-center md:text-left space-y-6">
                <div>
                  <h3 className="text-3xl font-bold font-montserrat mb-2 text-white">{service.title}</h3>
                  <p className="text-lg text-primary font-semibold italic">{service.subtitle}</p>
                </div>
                <p className="text-xl text-muted-foreground leading-relaxed text-justify">{service.description}</p>
      ...
      <div className="mt-24 md:mt-32">
        <div className="max-w-4xl mx-auto bg-crimson text-white text-center py-12 px-6 rounded-2xl shadow-2xl shadow-crimson/40 animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold font-ubuntu animate-fade-in">Ready to Elevate Your Payments?</h2>
          <p className="mt-4 text-lg max-w-2xl mx-auto text-white/90 animate-fade-in">
          ...
          <Button 
            ...
            className="mt-8 bg-white text-crimson font-bold py-6 px-8 rounded-lg text-lg hover:bg-white/90 hover:scale-105 transition-transform duration-300 shadow-lg animate-fade-in"
          >
            Contact Sales
          </Button>
        </div>
